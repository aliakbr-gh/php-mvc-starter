...
<body class="dashboard-body page-loading">
    ...
    <aside class="sidebar">
        <a class="brand" href="<?= htmlspecialchars(url('dashboard'), ENT_QUOTES, 'UTF-8') ?>">Core MVC</a>
        <div class="user-card">
        ...
        <nav class="side-nav">
            ...
            <?php endif; ?>
            <?php if (\App\Core\Auth::can('users.view')): ?><a href="<?= htmlspecialchars(url('admin/users'), ENT_QUOTES, 'UTF-8') ?>">Users</a><?php endif; ?>
            <?php if (\App\Core\Auth::can('roles.view')): ?><a href="<?= htmlspecialchars(url('admin/roles'), ENT_QUOTES, 'UTF-8') ?>">Roles</a><?php endif; ?>
            <?php if (\App\Core\Auth::can('permissions.view')): ?><a href="<?= htmlspecialchars(url('admin/permissions'), ENT_QUOTES, 'UTF-8') ?>">Permissions</a><?php endif; ?>
